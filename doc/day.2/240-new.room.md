...
A keď máme vytvorenú triedu `Room`, môžeme ju hneď využiť a vytvoriť inštanciu miestnosti `lietadlo`. V tejto miestnosti sa _Indiana Jones_ nachádza po spustení hry. Jej implementácia bude vyzerať nasledovne:
